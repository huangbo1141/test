...
import tepia.smartcycle.BuildConfig;
...
//                    }
    ...
    public void put(String data,Bitmap bmp){
    	BitmapDrawable bmpD=new RecyclingBitmapDrawable(bmp);
    	addBitmapToCache(data,bmpD);
    }
    
    public void remove(String data){
    	if (mMemoryCache!=null){
    		mMemoryCache.remove(data);
    		//mReusableBitmaps.remove(data);
    	}
    }
    ...
    public Bitmap get(String url){
    	BitmapDrawable bmpD=getBitmapFromMemCache(url);
    	if (bmpD!=null){
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        if (inputStream != null) {
                            ...
                            bitmap = ImageResizer.decodeSampledBitmapFromDescriptor(fd, Integer.MAX_VALUE, Integer.MAX_VALUE);
                        }
                    }
                } catch (final IOException e) {
